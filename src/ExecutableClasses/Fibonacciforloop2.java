...
public class Fibonacciforloop2
{
    ...
    {   //The Fibonacci sequence is a series of numbers where each number is the sum of the two preceding numbers,
        ...
        //Everytime we assign a value to a variable it is the next number in the sequence?
        int a = 0;
        System.out.println(a);
        int b = 1;
        System.out.println(b);
        //TODO declare C without a value, this needs more exploration.
        // It gets its value from the forloop. Whoa and brain explodes.
        int c = -1;
        //Initialize appears to be required here. I'll first try making it a number not in the sequence.
